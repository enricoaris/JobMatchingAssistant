...
from settings import MODEL_NAME, LLM_MODEL_HOST, OLLAMA_MODEL_NAME
import json
import re
import numpy as np

model = SentenceTransformer(MODEL_NAME)
CLIENT = ollama.Client(host=LLM_MODEL_HOST)
...
def build_match_asssesment_prompt(match_input: dict):
    system_prompt = """
